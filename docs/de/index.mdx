...
<CardGrid>
  ...
  <LinkCard
    ...
    title="CSD"
    description="Client-seitige Abwehr gegen browserbasierte Bedrohungen."
  ...
  <LinkCard
    ...
    title="WAS"
    description="Webanwendungs-Scanning und Schwachstellenbewertung."
...
<CardGrid>
  <LinkCard
    ...
    title="MCN"
    description="Multi-Cloud-Networking und Standortvernetzung."
  ...
  <LinkCard
    icon="f5xc:nginx-one"
    title="NGINX"
    description="NGINX-Integration und Konfigurationsmanagement."
...
<CardGrid>
  ...
  <LinkCard
    ...
    title="Dev Container"
    description="Isolierte Entwicklungsumgebung mit KI-Codierungstools."
...
<CardGrid>
  <LinkCard
    ...
    description="Verwalten Sie F5 XC-Ressourcen aus VS Code mit IntelliSense und xcsh-Chat-Assistent."
