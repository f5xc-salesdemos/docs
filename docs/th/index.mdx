---
title: F5 Distributed Cloud สาธิตการขาย
...
<CardGrid>
  <LinkCard
    ...
    title="WAF"
    description="การกำหนดค่าและนโยบายไฟร์วอลล์สำหรับเว็บแอปพลิเคชัน"
  ...
  <LinkCard
    icon="f5xc:bot-defense"
    title="Bot มาตรฐาน"
    description="การป้องกันบอทมาตรฐานด้วยการตรวจจับตามลายเซ็น"
...
<CardGrid>
  ...
  <LinkCard
    ...
    title="CDN"
    description="เครือข่ายส่งมอบเนื้อหาและการแคชที่ Edge"
...
<CardGrid>
  <LinkCard
    ...
    description="VM Ubuntu 24.04 ที่มีเว็บแอปพลิเคชันที่มีช่องโหว่ 9 รายการสำหรับการทดสอบ WAF, API และการป้องกันบอท"
    href="https://f5xc-salesdemos.github.io/origin-server/"
  />
  <LinkCard
    icon="f5xc:application-traffic-insight"
    title="ตัวสร้างทราฟฟิก"
    description="Azure VM ที่มีเครื่องมือความปลอดภัยมากกว่า 50 รายการและชุดโจมตี 7 ชุดสำหรับการสร้างทราฟฟิกสาธิต"
    href="https://f5xc-salesdemos.github.io/traffic-generator/"
  />
  <LinkCard
    icon="f5xc:content-delivery-network"
    title="ตัวจำลอง CDN"
    description="ตัวจำลองโหนด CDN Edge ที่ใช้ NGINX พร้อม Header เฉพาะผู้ให้บริการมากกว่า 67 รายการ"
    href="https://f5xc-salesdemos.github.io/cdn-simulator/"
  />
  <LinkCard
    icon="f5xc:platform"
    title="ดูส่วนประกอบทั้งหมด"
    description="เรียกดูแค็ตตาล็อกทรัพยากรสาธิตทั้งหมด"
...
<CardGrid>
  ...
  <LinkCard
    icon="f5xc:data-intelligence"
    title="API Specs แบบเสริมข้อมูล"
    description="OpenAPI Specifications แบบเสริมข้อมูลสำหรับ F5 Distributed Cloud"
...
<CardGrid>
  <LinkCard
    icon="f5xc:doc"
    title="Builder"
    description="ระบบสร้างเอกสาร Astro + Starlight แบบ Containerized"
    href="https://f5xc-salesdemos.github.io/docs-builder/"
  />
  <LinkCard
    icon="f5xc:shared-configuration"
    title="ธีม"
    description="การสร้างแบรนด์และการจัดรูปแบบร่วมกันสำหรับเว็บไซต์เอกสาร"
  ...
  <LinkCard
    icon="f5xc:shared-configuration"
    title="การควบคุม"
    description="เวิร์กโฟลว์ CI เทมเพลตการกำกับดูแล และการบังคับใช้การตั้งค่ารีโป"
...
<CardGrid>
  <LinkCard
    icon="f5xc:ai_assistant_logo"
    title="Marketplace"
    description="Marketplace ที่ขับเคลื่อนด้วย AI สำหรับโซลูชัน F5 Distributed Cloud"
