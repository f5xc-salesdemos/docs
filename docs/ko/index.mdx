...
<CardGrid>
  ...
  <LinkCard
    ...
    description="데모 트래픽 생성을 위한 50개 이상의 보안 도구와 7개의 공격 스위트가 포함된 Azure VM."
...
<CardGrid>
  ...
  <LinkCard
    ...
    title="API Specs"
    description="F5 Distributed Cloud용 OpenAPI 사양 검증 및 조정."
    href="https://f5xc-salesdemos.github.io/api-specs/"
  />
  <LinkCard
    icon="f5xc:data-intelligence"
    title="API Specs Enriched"
    description="F5 Distributed Cloud용 보강된 OpenAPI 사양."
