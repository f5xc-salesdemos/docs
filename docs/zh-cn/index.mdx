...
description: F5 Distributed Cloud 售前工程师的演示指南和运行手册。
template: splash
hero:
  title: Sales Demos
...
<CardGrid>
  ...
  <LinkCard
    ...
    title="Bot Advanced"
    description="基于行为分析的高级机器人防护。"
    href="https://f5xc-salesdemos.github.io/bot-advanced/"
  />
  <LinkCard
    icon="f5xc:bot-defense"
    title="Bot Standard"
    description="基于签名检测的标准机器人防护。"
...
<CardGrid>
  <LinkCard
    ...
    title="Origin Server"
    description="Ubuntu 24.04 虚拟机，包含 9 个易受攻击的 Web 应用，用于 WAF、API 和机器人防护测试。"
    href="https://f5xc-salesdemos.github.io/origin-server/"
  />
  <LinkCard
    icon="f5xc:application-traffic-insight"
    title="Traffic Generator"
    description="Azure 虚拟机，配备 50 多种安全工具和 7 个攻击套件，用于演示流量生成。"
...
<CardGrid>
  <LinkCard
    ...
    description="F5 Distributed Cloud 的 Terraform 提供程序。"
  ...
  <LinkCard
    ...
    description="F5 Distributed Cloud 的增强版 OpenAPI 规范。"
...
<CardGrid>
  <LinkCard
    icon="f5xc:doc"
    title="Builder"
    description="基于容器化的 Astro + Starlight 文档构建系统。"
  ...
  <LinkCard
    icon="f5xc:distributed-apps"
    title="Icons"
    description="文档构建系统的 NPM 图标包和插件。"
    href="https://f5xc-salesdemos.github.io/docs-icons/"
  />
  <LinkCard
    icon="f5xc:shared-configuration"
    title="Control"
    description="CI 工作流、治理模板和仓库设置执行。"
...
<CardGrid>
  ...
  <LinkCard
    ...
    title="xcsh CLI"
    description="面向 F5 Distributed Cloud 运维的 AI 驱动命令行工具。"
...
<CardGrid>
  <LinkCard
    icon="f5xc:ai_assistant_logo"
    title="Marketplace"
    description="面向 F5 Distributed Cloud 解决方案的 AI 驱动市场。"
