...
<CardGrid>
  <LinkCard
    ...
    title="WAF"
    description="Webアプリケーションファイアウォールの構成とポリシー。"
    href="https://f5xc-salesdemos.github.io/waf/"
  />
  <LinkCard
    icon="f5xc:web-app-and-api-protection"
    title="API"
    description="APIディスカバリー、保護、およびセキュリティポリシー。"
  ...
  <LinkCard
    icon="f5xc:bot-defense"
    title="Bot Standard"
    description="シグネチャベースの検出による標準ボット防御。"
...
<CardGrid>
  ...
  <LinkCard
    icon="f5xc:content-delivery-network"
    title="CDNシミュレーター"
    description="67以上のベンダー固有ヘッダーに対応したNGINXベースのCDNエッジノードシミュレーター。"
    href="https://f5xc-salesdemos.github.io/cdn-simulator/"
  />
  <LinkCard
    icon="f5xc:platform"
    title="全コンポーネントを表示"
    description="デモリソースカタログの全体を閲覧。"
...
<CardGrid>
  <LinkCard
    ...
    title="オブザーバビリティ"
    description="監視、メトリクス、およびアプリケーションインサイト。"
...
<CardGrid>
  <LinkCard
    ...
    description="F5 Distributed Cloud向けTerraformプロバイダー。"
    href="https://f5xc-salesdemos.github.io/terraform-provider-f5xc/"
  />
  <LinkCard
    icon="f5xc:data-intelligence"
    title="API仕様"
    description="F5 Distributed Cloud向けOpenAPI仕様のバリデーションとリコンシリエーション。"
    href="https://f5xc-salesdemos.github.io/api-specs/"
  />
  <LinkCard
    icon="f5xc:data-intelligence"
    title="API仕様（エンリッチ版）"
    description="F5 Distributed Cloud向けのエンリッチされたOpenAPI仕様。"
...
<CardGrid>
  ...
  <LinkCard
    ...
    title="テーマ"
    description="ドキュメントサイト向けの共有ブランディングとスタイリング。"
    href="https://f5xc-salesdemos.github.io/docs-theme/"
  />
  <LinkCard
    icon="f5xc:distributed-apps"
    title="アイコン"
    description="ドキュメントビルドシステム向けのNPMアイコンパッケージとプラグイン。"
...
<CardGrid>
  <LinkCard
    icon="f5xc:distributed-apps"
    title="VS Code拡張機能"
    description="IntelliSenseとxcshチャットアシスタントを使用してVS CodeからF5 XCリソースを管理。"
    href="https://f5xc-salesdemos.github.io/vscode-f5xc-tools/"
  />
  <LinkCard
    icon="f5xc:ai_assistant_logo"
    title="xcsh CLI"
    description="F5 Distributed Cloud運用向けのAI搭載シェル。"
...
<CardGrid>
  <LinkCard
    icon="f5xc:ai_assistant_logo"
    title="マーケットプレイス"
    description="F5 Distributed Cloudソリューション向けのAI搭載マーケットプレイス。"
